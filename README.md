...
Backend for this application can be found here: https://github.com/shekhars271991/AskPDFApp
Features
...
Usage
Upload PDFs: Navigate to the upload page and select your PDF files.
Ask Questions: On the main page, type questions related to the PDF content and view responses.
View and Manage Documents: Access uploaded documents, view contents, or download files.
Project Structure
